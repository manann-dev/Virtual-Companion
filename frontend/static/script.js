window.onload = function() {
    ...
    function generateImage(textInput, negativePrompt, gender, ethnicity, hairColor, face, hairStyle, eyesColor,
        ...
        //         } else {
        //             console.log("=========  ", data)
        //             // imagesToDisplay = data.image_url && data.image_url.length > 0 ?
        //             //     data.image_url : ['https://aihentaigenerator.net/wp-content/uploads/2023/11/AIGDefaultimage1.png']; // Default image URL
        //             // console.log("image length", )
        //             // displayImages(imagesToDisplay); // Display images
        //         }
        //     })
        //     .catch((error) => {
    ...
    socket.on("webhook", function(data) {
        ...
        if (data.uniqueId === currentUniqueId ) {
            // clearTimeout(countdownTimer); // Clear the timeout timer
    ...
    form.addEventListener('submit', function(event) {
        ...
        // var eyesColor = document.getElementById('eyesColor').value;
        ...
        // var self_attention = document.getElementById('self_attention').classList.contains('active') ? "yes" : "no";
        // var panorama = document.getElementById('panorama').classList.contains('active') ? "yes" : "no";
        // var upscale = document.getElementById('image_size').classList.contains('active') ? "yes" : "no";
        // var no_watermark = document.getElementById('no_watermark').classList.contains('active') ? "yes" : "no";
        // var isPrivateGallery = document.getElementById('private_gallery').classList.contains('active');
