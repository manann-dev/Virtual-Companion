...
# model_name = "TheBloke/Yarn-Mistral-7B-128k-GGUF"
...
loaded_model = load_model('NousResearch_Yarn-Llama-2-7b-128k', 'Transformers')
initialize_shared_components('NousResearch/Yarn-Llama-2-7b-128k')
model = AutoModelForCausalLM.from_pretrained("NousResearch/Yarn-Llama-2-7b-128k")
