...
class Character(db.Model):
    ...
    greerings = db.Column(db.String, nullable=False)
...
def get_characters():
    ...
    characters_list = [{'id': character.id, 'name': character.name, 'greetings' : character.greerings, 'context': character.context, 'images': character.images} for character in characters]
...
async def handle_send_message(data):
    ...
    try:
        ...
        response_generator = generate_reply_HF(modified_question, question, None, state, character=character.name)
        character_response = ""
